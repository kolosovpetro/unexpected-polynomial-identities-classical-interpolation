...
in particular finite differences of cubes, that was year 2014
...
The problem of interpolation is quite old, so that it can be traced back
...
By observing the table of finite differences from table~\eqref{tab:finite-differences-cubes}, we can notice that
...
was not really aware of the approaches above neither.
What a lazy student!
