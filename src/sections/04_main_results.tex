...
\begin{proposition}[Odd power central decomposition] For non-negative integers $m$ and $n$
...
\begin{proposition}[Odd power central decomposition shifted] For non-negative integers $m$ and $n$
