...
\input{sections/equations/02_main_results_forward_decompositions}
\input{sections/equations/03_main_results_backward_decompositions}
\input{sections/equations/04_main_results_binomial_forms}
\input{sections/equations/05_main_results_sums_of_odd_powers}
\input{sections/equations/06_main_results_double_bivariate_sums}
