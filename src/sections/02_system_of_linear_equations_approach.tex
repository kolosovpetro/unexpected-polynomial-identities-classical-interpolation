...
\end{align*}
By observing the equation above, the general form of odd-power identity becomes more clear and obvious.
...
\end{equation*}
By multiplying by $30$ both, RHS and LHS, we get
\begin{equation*}
    30 \coeffA{2}{0} n + 5 \coeffA{2}{1} (n^3-n) + \coeffA{2}{2} (n^5-n) - 30n^5 = 0
\end{equation*}
By expanding the brackets and rearranging the terms yields
\begin{equation*}
...
\begin{align*}
    T_2 (n,k) = T_2 (n,n-k)
\end{align*}
By arranging the values of $T_{2} (n,k)$ as tabular, we may observe that the identity for $n^5$ above is indeed true
...
\begin{conjecture}
    ...
    \end{align*}
\end{conjecture}
As we already know, we have to build and solve a system of linear equation to evaluate the set of coefficients
