...
\begin{proposition}[Recurrence for $T_m$] For non-negative integers $m$ and $n$
    \begin{align*}
        T_{m} (n, k) = \sum_{t=1}^{m+1} (-1)^{t-1} \binom{m+1}{t} T_{m} (n-t, k)
    \end{align*}
\end{proposition}

\begin{proposition}[Odd power decomposition] For non-negative integers $m$ and $n$
    \begin{align*}
...
\begin{proposition}[Odd power binomial form] For integers $n$ and $a$ such that $n-2a \geq 0$
    \begin{align*}
    (n-2a)
