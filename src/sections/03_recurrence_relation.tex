In 2018, the recurrence relation~\cite{alekseyev2018mathoverflow} for the coefficients $\coeffA{m}{r}$
was provided by Dr. Max Alekseyev, George Washington University.
...
of Faulhaber's formula~\cite{beardon1996sums} with upper summation bound equal to $p+1$
\begin{align*}
    \sum_{k=1}^{n} k^{p}
...
$(n-k)^r=\sum_{t=0}^{r} (-1)^t \binom{r}{t} n^{r-t} k^t$
\begin{align*}
...
Taking the coefficient of $n^{2d+1}$ for $d$ in the range $\frac{m}{4} \leq d < \frac{m}{2}$ in~\eqref{eq:generating-function}, we obtain
\begin{align*}
