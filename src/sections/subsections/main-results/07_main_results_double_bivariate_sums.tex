\subsection{Double bivariate identities}
\label{subsec:double-bivariate-identities}
\begin{definition}[Double bivaraite sum $R_{m}$]
    \label{def:double-bivariate-sum-r}
    For non-negative integers $m,n$ and $t$
    \begin{align*}
        R_{m}(n,t) = \sum_{k=1}^{n} \sum_{r=0}^{m} \coeffA{m}{r} k^r (n+t-k)^r
    \end{align*}
\end{definition}
The polynomial $R_{m}(n,t)$ is a polynomial of degree $2m+1$ in $n$, and of degree $m$ in $t$.
\begin{proposition}[Odd power double bivariate]
    \label{prop:odd-power-double-bivariate}
...
\begin{proposition}[Odd power double bivariate negated]
    \label{prop:odd-power-double-bivariate-negated}
    For non-negative integers $m,n$
    \begin{align*}
        n^{2m+1} = \sum_{t=1}^{m+1} (-1)^{t+1} \binom{m+1}{t} R_{m} (n, -t)
    \end{align*}
...
\end{itemize}
\begin{proposition}[Odd power double bivariate multifold]
    \label{prop:odd-power-double-bivariate-multifold}
    For non-negative integers $m,n$ and $s\geq 1$
    \begin{align*}
        n^{2m+1} = \sum_{t=1}^{m+s} (-1)^{t+1} \binom{m+s}{t} R_{m} (n, t)
    \end{align*}
\end{proposition}
\begin{proposition}[Odd power double bivariate negated multifold]
    \label{prop:odd-power-double-bivariate-negated-multifold}
    For non-negative integers $m,n$ and $s \geq 1$
    \begin{align*}
        n^{2m+1} = \sum_{t=1}^{m+s} (-1)^{t+1} \binom{m+s}{t} R_{m} (n, -t)
    \end{align*}
